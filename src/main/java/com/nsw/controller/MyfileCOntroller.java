...
public class MyfileCOntroller {
    ...
    public String uploadFile(@RequestParam("fileName") MultipartFile file) {
        ...
        //加个时间戳，尽量避免文件名称重复
        String path = "D:/zhaopian/" + fileName;
        //文件绝对路径
        ...
        try {
            ...
            url = "http://localhost:8080/zhaopian/" + fileName;
    ...
    public String update(@RequestParam("id") int id,@RequestParam("zhuanji") String zhuanji){
        System.out.println("开始修改专辑");
        Shipin shipin = new Shipin();
        shipin.setId(id);
        shipin.setZhuanji(zhuanji);
        System.out.println(shipin);
        int result = shiPinService.update(shipin);
        return "/edit";
    }
}
